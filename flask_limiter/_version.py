...
def get_keywords():
    ...
    # get_keywords().
    git_refnames = " (tag: 3.1.0)"
    git_full = "745964acbc31048af1fedca09a1637df8278c760"
    git_date = "2022-12-29 11:54:32 -0800"
...
def get_config():
    ...
    cfg.tag_prefix = ""
    cfg.parentdir_prefix = "flask-limiter-"
    cfg.versionfile_source = "flask_limiter/_version.py"
    cfg.verbose = False
    return cfg
